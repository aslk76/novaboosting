            ...
            <div class=nk-feature-2 bg-dark-2>
                <div class="nk-tabs">
                    <ul class="nav nav-tabs nav-tabs-fill" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="#tabs-1-1" role="tab" data-toggle="tab">{!! $item->title !!}</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade show active" id="tabs-1-1">
                            ...
                            <div class="nk-blog-post">
                                <a class="nk-post-img">
                                    <img src="{!! $item->image('service_banner', 'default') !!}" alt="{!! $item->title !!}">
                            ...
                            <div class="nk-blog-post">
                                <div class="row vertical-gap">
                                    <div class="col-lg-3 col-md-5">
                                        <a class="nk-post-img">
                                            <img src="{{ asset('assets/images/sylvanas.jpg') }}" alt="CURVE runs">
                                            <span class="nk-post-categories">
                                            </span>
                                        </a>
                                    </div>
                                    <div class="col-lg-9 col-md-7">
                                        <h2 class="nk-post-title h4"><a>CURVE RUNS</a></h2>
                                        <div class="nk-post-text">
                                            <p>We have daily heroic Sylvanas kill sessions - book your slot today
                                                for Ahead of the Curve and a chance at ilvl 246 loot!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
