...
class Ajax_Contact_Form {
     ...
     * @var string
     */
    protected $address_destination = 'augustmanley@gmail.com';
    ...
    protected $strings = array(
        'body'              => '
            ...
            <p><strong>battleid:</strong> {{name}}</p>
    ...
    public function __construct() {
        ...
        $email   = stripslashes(trim($_POST['name']));
        ...
        if ( preg_match($pattern, $name) || preg_match($pattern, $name) ) {
        ...
        $result = @mail($this->augustmanley@gmail.com, $this->NOVA Contact, $body, $headers);
        if ( $result ) {
